...
--
-- Host: localhost
-- Generation Time: Oct 01, 2025 at 09:35 PM
...
CREATE TABLE `usuarios` (
  ...
  `verificacion` mediumtext NOT NULL,
  `social_network` varchar(20) NOT NULL,
  `app_id` varchar(30) NOT NULL,
  `recuperacion` varchar(30) NOT NULL,
  `id_clientes` int(11) NOT NULL,
  `invitacion` varchar(50) NOT NULL,
  `estado` varchar(50) NOT NULL,
  `vendedor_meta_barriles` int(11) NOT NULL DEFAULT 0,
  `vendedor_meta_cajas` int(11) NOT NULL DEFAULT 0,
  `prevlink_direction` varchar(10) NOT NULL,
  `prevlink_count` int(11) NOT NULL DEFAULT 0,
  `id_secciones` int(11) NOT NULL DEFAULT 0,
  `registro_asistencia` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
