        ...
        <tr data-idgastosfijos="<?= $gasto->id; ?>">
            ...
            for($i = 1; $i<=12; $i++) {
                ...
                if($gasto->visible == 1) {
                  ...
                  $mes_real_bruto = $montos->real_neto;
                  $montos_id = $montos->id;
      ...
      <div class="modal-content">
        ...
        <form action="./php/modificar-gastos-fijos-mes.php" method="post" enctype="multipart/form-data" id="modificar-gastos-fijos-mes-form">
          ...
          <div class="row">
            ...
            <div class="col-3 mb-1">
              <select class="form-control" id="modificar-gastos-fijos-mes-tipo_de_gasto-select" DISABLED>
                <?php
                  foreach($tdgs as $tdg) {
            ...
            <div class="col-3 mb-1">
              <select class="form-control" name="mes" id="modificar-gastos-fijos-mes-mes-select" DISABLED>
                <?php
                  for($i = 1; $i <= 12; $i++) {
            ...
            <div class="col-3 mb-1">
              <select class="form-control" name="ano" id="modificar-gastos-fijos-mes-ano-select" DISABLED>
                <?php
                  for($i = 2023; $i <= (date('Y') + 1); $i++) {
                    print "<option>".$i."</option>";
                  }
