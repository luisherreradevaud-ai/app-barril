<?php
  ...
  foreach($clientes as $cliente) {
    $pedidos = array_merge($pedidos,Pedido::getAll("WHERE id_clientes='".$cliente->id."' ORDER BY id desc"));
  }
...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
  <div class="mb-2">
    ...
    <h1 class="h5 mb-0 text-gray-800">Pedidos del Vendedor</h1>
  </div>
    <a href="./?s=detalle-vendedores&id=<?= $vendedor->id; ?>" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-2"><i class="fas fa-fw fa-backward"></i> Volver a Vendedor</a>
