...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
  <div class="mb-2">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-user"></i> <b>Usuarios externos</b></h1>
  </div>
  <div>
    <div>
...
$(document).on('click','.tr-usuarios',function(e){
  window.location.href = "./?s=detalle-usuarios&tipo_usuario=externo&id=" + $(e.currentTarget).data('idusuarios');
});
