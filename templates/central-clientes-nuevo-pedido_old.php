    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-6 mb-3">
            <select class="form-control" id="productos-barriles-cantidad-select">
              <option>20L</option>
              <option>30L</option>
            </select>
          </div>
          ...
          <div class="col-6 mb-3">
            <select class="form-control" id="productos-barriles-id-select">
            </select>
          </div>
          <div class="col-6 mb-3">
            Cantidad
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-6 mb-3">
            <select class="form-control" id="productos-cajas-cantidad-select">
              <option>Tripack</option>
              <option>24</option>
            </select>
          </div>
          <div class="col-6 mb-3">
          ...
          <div class="col-6 mb-3">
            <select class="form-control" id="productos-cajas-id-select">
            </select>
          </div>
          <div class="col-6 mb-3">
            Cantidad
...
function renderTable() {
  var html = '';
  productos_list.forEach(function(producto,index){
...
$(document).on('click','.item-eliminar-btn',function(e){
  ...
  if(productos_list[index].tipo == 'CO2') {
    co2 = false;
  }
  if(productos_list[index].tipo == 'Vasos') {
    vasos = false;
  }
