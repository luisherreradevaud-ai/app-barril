<?php
  ...
  $query .= " WHERE entregas.creada BETWEEN '".$date_inicio." 00:00:00' AND '".$date_final." 23:59:59'";
...
<div class="mb-3">
  <select class="form-control vista-select" style="max-width: 300px"  data-select="id_clientes">
...
?>
<table class="table table-hover table-striped table-sm" id="entregas-table">
      ...
      foreach($entregas as $entrega) {
        ...
        foreach($entrega_productos as $entrega_producto) {
          if($entrega_producto->tipo == "Barril") {
            if(!isset($barriles_arr[$entrega_producto->tipos_cerveza])) {
              $barriles_arr[$entrega_producto->tipos_cerveza] = 0;
              $totales[$entrega_producto->tipos_cerveza] = 0;
            }
...
function cambiarVista() {
  ...
  if(modo == 'Semanal') {
    window.location.href = "./?s=entregas&lunes=" + lunes + "&id_clientes=" + id_clientes + "&mes=" + mes + "&ano=" + ano + "&modo=" + modo + "&order_by=" + order_by + "&order=" + order;
  }
  if(modo == 'Mensual') {
    window.location.href = "./?s=entregas&mes=" + mes + "&ano=" + ano + "&id_clientes=" + id_clientes + "&modo=" + modo + "&order_by=" + order_by + "&order=" + order;
  }
  if(modo == 'Trimestral') {
    window.location.href = "./?s=entregas&trimestre=" + trimestre + "&ano=" + ano + "&id_clientes=" + id_clientes + "&modo=" + modo + "&order_by=" + order_by + "&order=" + order;
  }
  if(modo == 'Semestral') {
    window.location.href = "./?s=entregas&semestre=" + semestre + "&ano=" + ano + "&id_clientes=" + id_clientes + "&modo=" + modo + "&order_by=" + order_by + "&order=" + order;
  }
  if(modo == 'Historico') {
    window.location.href = "./?s=entregas&id_clientes=" + id_clientes + "&modo=" + modo + "&order_by=" + order_by + "&order=" + order;
  }
  if(modo == 'Anual') {
    window.location.href = "./?s=entregas&ano=" + ano + "&id_clientes=" + id_clientes + "&modo=" + modo + "&order_by=" + order_by + "&order=" + order;
  }
