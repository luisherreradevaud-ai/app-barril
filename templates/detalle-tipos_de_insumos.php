...
if($msg == 1) {
?>
<div class="alert alert-info" role="alert" >Tipo de Insumo guardado con &eacute;xito.</div>
<?php
}
?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <center><h5>Desea eliminar este Tipo de Insumo?<br/>Este paso no es reversible.</h5></center>
        </div>
